...
wget https://raw.githubusercontent.com/ignitiontesting/release-tools/master/jenkins-scripts/tools/detect_cmake_major_version.py
...
wget https://raw.githubusercontent.com/ignitiontesting/release-tools/master/jenkins-scripts/tools/detect_ci_matching_branch.py
